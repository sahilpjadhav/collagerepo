...
<div class="container  rounded"> 
  ...
  <div class = "row ">
   ...
   <div class = "row">
    <div class="col"><h3> Donors Details</h3></div>
  </div>
  <div class="row">
   <div class="col">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        <thead class="thead-dark">
          <tr class="">
            ...
            <th class="" scope="col">Bank</th>
            <th class="" scope="col">Account No</th>
            <th class="" scope="col">Total Donation</th>
          </tr>
        </thead>
        <tbody class="">
          <?php 
            $stmt3 = $pdo->query("SELECT * from donor_details");
            $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
            $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
                echo "<th scope='row' class=''>".$count."</th>";
                echo "<td class=''>".htmlentities($row['donor_name'])."</td>";
                echo "<td class=''>".htmlentities($row['donor_email'])."</td>";
                echo "<td class=''>".htmlentities($row['donor_address'])."</td>";
                echo "<td class=''>".htmlentities($row['donor_phone'])."</td>";
                echo "<td class=''>".htmlentities($row['city_name'])."</td>";
                echo "<td class=''>".htmlentities($row['bank_name'])."</td>";
                echo "<td class=''>".htmlentities($row['account_details'])."</td>";
                echo "<td class=''>".htmlentities($row['total_donations'])."</td>";
                echo "</tr>";
              $count++;
              }
            ?>
